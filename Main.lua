...
local main
main = __LAZY(function()
  return __EAGER(__EAGER(__EAGER(__EAGER(__EAGER(__EAGER(Math)["random"]))(__EAGER(__INT(0)), __EAGER(__INT(100))))["_OP___GT__GT__EQ_"])(function(n)
    return __EAGER(__EAGER(__EAGER(__EAGER(__EAGER(__EAGER(Math)["random"]))(__EAGER(__INT(0)), __EAGER(__INT(100))))["_OP___GT__GT__EQ_"])(function(m)
      return __EAGER(__EAGER(println)(__EAGER(__EAGER(n["_OP___PLUS_"])(m))))
    end))
  end))
end)
__EVAL(main)